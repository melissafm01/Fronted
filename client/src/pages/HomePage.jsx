        ...
        <div className="md:flex h-full">
          <div className="p-12 md:w-1/2 flex flex-col justify-center">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight">
              <span className="text-[#064349]">PanascOOP</span>: Innovación
              social colectiva
            </h1>
            <div className="h-1 w-16 bg-[#03683E] mb-8"></div>

            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              PanascOOP es una plataforma que conecta comunidades y fomenta la
              economía solidaria. Facilitamos la organización de proyectos
              colectivos y promovemos la participación ciudadana a través de la
              colaboración, educación y transparencia. Juntos transformamos
              ideas en realidades."
            </p>
              ...
              {[
                ...
                <div key={index} className="flex items-start group">
                  <div className="bg-[#e8f4f0] p-2 rounded-full mr-3 mt-1 group-hover:bg-[#03683E] transition-colors">
                    <svg
                      className="w-5 h-5 text-[#064349] group-hover:text-white transition-colors"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 group-hover:text-[#03683E] transition-colors">
                      {item.title}
                    </h3>
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-semibold text-[#064349] mb-4">
                Nuestra filosofía
              </h2>
              <p className="text-gray-600 leading-relaxed">
                Creemos en la colaboración, la educación y la transparencia.
                Transformamos ideas en acciones colectivas, construyendo futuro
                con solidaridad.
              </p>
            </div>
            ...
            <div className="relative w-full h-full overflow-hidden rounded-lg">
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white space-y-2">
                <p className="text-xl font-medium drop-shadow-lg">
                  "Juntos construimos el cambio que queremos ver"
                </p>
